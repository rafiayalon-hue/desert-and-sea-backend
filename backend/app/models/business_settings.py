...
class BusinessSettings(Base):
    ...
    # NEW (16.7.26): פרטי חשבון בנק להעברה — לאורחים שמבקשים לשלם כך,
    # כדי שאבישג תוכל לגשת ולשלוח בעצמה בלי לחכות לרפי.
    bank_name: Mapped[str | None] = mapped_column(String(200), nullable=True, default="הבנק הבינלאומי (31)")
    bank_branch: Mapped[str | None] = mapped_column(String(200), nullable=True, default="ראשי ירושלים (12)")
    bank_account_number: Mapped[str | None] = mapped_column(String(50), nullable=True, default="184921")
    bank_account_holder: Mapped[str | None] = mapped_column(String(200), nullable=True, default="מדבר וים")
