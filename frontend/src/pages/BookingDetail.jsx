...
export default function BookingDetail({ bookingId, navigate }) {
  ...
  // הערות
  const [internalNotes, setInternalNotes] = useState(null); // null = טרם טעון
  const [savingNotes,   setSavingNotes]   = useState(false);
  const [notesSaved,    setNotesSaved]    = useState(false);

  // תשלום
  const [paymentMethod, setPaymentMethod] = useState(null); // null = טרם טעון
  ...
  // אתחל ערכים מה-booking בפעם הראשונה
  ...
  const openPreview = (type, templateId) => {
    const body = buildMessageBody(templateId, lang, booking, ttlockCode, curPayLink);
