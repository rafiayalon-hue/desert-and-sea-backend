...
function BottomNav({ currentPage, navigate, unreadCount }) {
  const items = [
    ...
    { id: "conversations", label: "שיחות", icon: "💬", badge: unreadCount }, // NEW (17.7.26)
...
export default function App() {
  ...
  function renderPage() {
    switch (currentPage) {
      ...
      case "conversations": return <Conversations navigate={navigate} onOpenConversation={markSeen} />; // NEW
